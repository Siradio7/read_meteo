...
function App() {
    ...
    return (
        <>
            <MemoizedAnimatedBackground weather={weather} />
            <div className="flex justify-center items-center min-h-screen p-4 md:p-8 animate__animated animate__fadeIn animate__faster">
                <div className="bg-gray-800/80 backdrop-blur-sm p-6 md:p-8 rounded-lg shadow-xl max-w-md w-full animate__animated animate__fadeInUp animate__faster">
